...
/*Read the data from DB */
	...
	$sql = "SELECT * FROM events WHERE events.date BETWEEN ? AND ? AND userid='$userid' AND type='6' ORDER BY events.date ASC";
	...
	$sql = "SELECT * FROM events WHERE events.date BETWEEN ? AND ? AND userid='$userid' OR type='5' OR type='6' ORDER BY events.date ASC";
	return $this->db->query($sql, array($_GET['start'], $_GET['end']))->result();
