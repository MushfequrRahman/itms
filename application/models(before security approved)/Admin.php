...
//	}
  ...
  public function usertype_insert($usertype)
	...
	public function useraccess_insert($userid,$bsre,$bswr,$tsre,$tswr,$lsre,$lswr,$nare,$nawr,$pare,$pawr,$eare,$eawr,$trre,$trwr,$swotre,$swotwr,$eore,$eowr,$mmre,$mmwr,$mmallure,$mmchac,$hrre,$hrwr,$care,$cawr,$capre,$capwr,$scre,$scwr,$dcre,$dcwr,$sbre,$sbwr,$prre,$prwr,$vtre,$vtwr,$ihre,$ihwr,$odre,$bldgre,$bldgwr,$recruitmentre,$recruitmentwr,$irre,$irwr,$baslre,$baslwr,$adminre,$adminwr)
	{
		...
		{
		$sql="INSERT INTO user_access VALUES ('$userid','$bsre','$bswr','$tsre','$tswr','$lsre','$lswr','$nare','$nawr','$pare','$pawr','$eare','$eawr','$trre','$trwr','$swotre','$swotwr','$eore','$eowr','$mmre','$mmwr','$mmallure','$mmchac','$hrre','$hrwr','$care','$cawr','$capre','$capwr','$scre','$scwr','$dcre','$dcwr','$sbre','$sbwr','$prre','$prwr','$vtre','$vtwr','$ihre','$ihwr','$odre','$bldgre','$bldgwr','$recruitmentre','$recruitmentwr','$irre','$irwr','$baslre','$baslwr','$adminre','$adminwr')";
		$query=$this->db->query($sql);
		return $query;
		}
	}
...
$query="SELECT user.factoryid,user.userid,factory.factoryname,division.divisionname,(user.divisionid) AS diviid,user.departmentid,department.deptid,department.departmentname,user.sectionid,section.sectionname,user.subsectionid,subsection.subsectionname,user.location,user.ename,user.bname,user.parentdesignationid,user.childdesignationid,user.religion,user.maritual,user.dob,user.doj,user.hdistrict,user.epermanentaddress,user.bpermanentaddress,user.epresentaddress,user.bpresentaddress,user.nid,user.blodgroup,user.gender,user.salary,user.efficiency,user.identification,user.oemail,user.pemail,user.pmobile,user.emobile,user.user_type,user.service_type,user.puserid,user.ruserid,user.password,user.ustatus,usertype.usertypeid,usertype.usertype,servicetype.servicetypeid,servicetype.servicetype,userstatus.userstatusid,userstatus.userstatus,religion.religionid,religion.religionname,maritualstatus.maritualstatusid,maritualstatus.maritualstatus,gender.genderid,gender.gender,user.password,parentdesignation.eparentdesignation,parentdesignation.parentdesignationid,parentdesignation.bparentdesignation,childdesignation.childdesignationid,childdesignation.echilddesignation,childdesignation.bchilddesignation,user.pperiod,user.pperiod_status,user.image  FROM user
	...
	{
		$sql1="SELECT user.factoryid,user.userid,factory.factoryname,division.divisionname,(user.divisionid) AS diviid,user.departmentid,department.deptid,department.departmentname,user.sectionid,section.sectionname,user.subsectionid,subsection.subsectionname,user.location,user.ename,user.bname,user.parentdesignationid,user.childdesignationid,user.religion,user.maritual,user.dob,user.doj,user.hdistrict,user.epermanentaddress,user.bpermanentaddress,user.epresentaddress,user.bpresentaddress,user.nid,user.blodgroup,user.gender,user.salary,user.efficiency,user.identification,user.oemail,user.pemail,user.pmobile,user.emobile,user.user_type,user.service_type,user.puserid,user.ruserid,user.password,user.ustatus,usertype.usertypeid,usertype.usertype,servicetype.servicetypeid,servicetype.servicetype,userstatus.userstatusid,userstatus.userstatus,religion.religionid,religion.religionname,maritualstatus.maritualstatusid,maritualstatus.maritualstatus,gender.genderid,gender.gender,user.password,parentdesignation.eparentdesignation,parentdesignation.parentdesignationid,parentdesignation.bparentdesignation,childdesignation.childdesignationid,childdesignation.echilddesignation,childdesignation.bchilddesignation,user.pperiod,user.pperiod_status,user.indate  FROM user
		LEFT JOIN factory ON factory.factoryid=user.factoryid
		LEFT JOIN division ON division.divisionid=user.divisionid 
		LEFT JOIN department ON department.deptid=user.departmentid
		LEFT JOIN section ON section.secid=user.sectionid
...
AND assignee_task_list.createtaskid=task_assignee_view.createtaskid
	...
	public function licensename_list()
	{
		...
		JOIN licensetype ON licensetype.licensetypeid=licensename.licensetype_id
	...
	public function licenselup($licenseid,$factoryid,$reauthority,$issuedate,$renewaldate,$processtime,$regulatoryfee,$misexp)
	{
...
$renewaldate = date("Y-m-d", strtotime($renewaldate));
$renewaldate=$renewaldate;
		$sql="UPDATE license SET factoryid='$factoryid',reauthority='$reauthority',issuedate='$issuedate',renewaldate='$renewaldate',processingtime='$processtime',regulatoryfee='$regulatoryfee',misexp='$misexp' WHERE licenseid='$licenseid'";
		$query=$this->db->query($sql);
	}
...
//	}
	...
	{
		$query="SELECT * FROM training_resourceperson
...
JOIN challanm2_insert ON challanm2_insert.chmid1=challanm1_insert.chmid
	...
	{
		$query="SELECT chmid,chmid2,manualid,sfactoryid,rfactoryid,buyername,sdate,stime,rdate,rtime,status,sqty,item_name,challanm2_insert.challantypeid,challantype,producttype,productunitname,description,remarks FROM challanm1_insert 
JOIN challanm2_insert ON challanm2_insert.chmid1=challanm1_insert.chmid
		LEFT JOIN productunit ON productunit.productunitid=challanm2_insert.item_unit
		LEFT JOIN producttype ON producttype.producttypeid=challanm2_insert.producttypeid
		LEFT JOIN challantype ON challantype.challantypeid=challanm2_insert.challantypeid
...
//			$query=$this->db->query($sql);
			$sql1="UPDATE challanm1_insert SET rdate=CURDATE(),rtime=CURTIME(),status='0' WHERE chmid='$data[chmid]'";
			$this->db->query($sql1);
			//return $query1=$this->db->query($sql1);
		//}
//		else
...
//			$rstatus=0;
	...
	{
		$query="SELECT chmid,chmid2,manualid,sfactoryid,rfactoryid,buyername,sdate,stime,rdate,rtime,status,sqty,rqty,item_name,challanm2_insert.challantypeid,challantype,producttype,productunitname,description,remarks FROM challanm1_insert 
JOIN challanm2_insert ON challanm2_insert.chmid1=challanm1_insert.chmid
		LEFT JOIN productunit ON productunit.productunitid=challanm2_insert.item_unit
		LEFT JOIN producttype ON producttype.producttypeid=challanm2_insert.producttypeid
		LEFT JOIN challantype ON challantype.challantypeid=challanm2_insert.challantypeid
...
//		$query1=$this->db->query($sql1);
	...
	public function date_wise_back_challanm_list($factoryid,$pd,$wd)
	{
		...
		LEFT JOIN challantype ON challantype.challantypeid=challanm2_insert.challantypeid
		LEFT JOIN buyer ON buyer.bid=challanm1_insert.buyerid
		JOIN challanm_back_insert ON challanm_back_insert.chmid_2=challanm2_insert.chmid1
	...
	public function date_wise_back_challanm_summary($factoryid,$pd,$wd)
	{
		$pd=date("Y-m-d", strtotime($pd));
		$wd=date("Y-m-d", strtotime($wd));
		$query="SELECT SUM(bkqty) AS bkqty,SUM(bkrqty) AS bkrqty,chmid,chmid_2,manualid,sfactoryid,buyername,rfactoryid,challantype,producttype,item_name,sqty,rqty,productunitname,sdate,stime,rdate,rtime,bkdate,bktime FROM challanm2_insert
		JOIN challanm1_insert ON challanm1_insert.chmid=challanm2_insert.chmid1
		LEFT JOIN productunit ON productunit.productunitid=challanm2_insert.item_unit
		LEFT JOIN producttype ON producttype.producttypeid=challanm2_insert.producttypeid
		LEFT JOIN challantype ON challantype.challantypeid=challanm2_insert.challantypeid
...
//	}
	public function capinfo_report($adate,$factoryname,$buyername,$audittype,$auditparty,$auditscope)
	{
		...
		JOIN auditparty ON auditparty.apid=preauditinfo.apid
		JOIN audittype ON audittype.atid=preauditinfo.atid
		JOIN auditscope ON auditscope.acid=preauditinfo.acid
		JOIN buyer ON buyer.bid=preauditinfo.bid
...
//		$d=str_replace("-","",$d);
	...
	public function addcase_insert($idate,$factoryid,$opponent,$lawyer,$casedetails,$courtname,$casetypeid,$casenumber,$adate)
	{
		$idate = date("Y-m-d", strtotime($idate));
		$adate = date("Y-m-d", strtotime($adate));
		$sql="INSERT INTO case_insert VALUES ('','$idate','$factoryid','$opponent','$lawyer','$casedetails','$courtname','$casetypeid','$casenumber','$adate','1')";
		$query=$this->db->query($sql);
		return $query;
	}
	public function case_list()
	{
		$query="SELECT case_insert.caseid,idate,factoryid,opponent,lawyer,casedetails,courtname,casetype,casenumber,adate,hfdate,cstatus FROM case_insert 
	...
	{
		$query="SELECT case_insert.caseid,idate,factoryid,opponent,lawyer,casedetails,courtname,casetype,casenumber,adate,cstatus,adffile FROM case_insert 
		LEFT JOIN casetype ON casetype.casetypeid=case_insert.casetypeid
	...
	{
		$query="SELECT case_insert.caseid,idate,factoryid,opponent,lawyer,casedetails,courtname,casetype,casenumber,hfdate,cstatus,hfile FROM case_insert 
		LEFT JOIN casetype ON casetype.casetypeid=case_insert.casetypeid
	...
	{
		$query="SELECT case_insert.caseid,idate,factoryid,opponent,lawyer,casedetails,courtname,casetype,casenumber,hfdate,cstatus FROM case_insert 
		LEFT JOIN casetype ON casetype.casetypeid=case_insert.casetypeid
		LEFT JOIN hearing_date_case_file_view ON hearing_date_case_file_view.caseid=case_insert.caseid
		WHERE case_insert.caseid='$caseid'";
		$result=$this->db->query($query);
	...
	public function caselup($idate,$factoryid,$opponent,$lawyer,$casedetails,$courtname,$casetypeid,$casenumber,$adate,$cstatus,$caseid)
	{
		$idate = date("Y-m-d", strtotime($idate));
		$adate = date("Y-m-d", strtotime($adate));
		$sql="UPDATE case_insert SET idate='$idate',factoryid='$factoryid',opponent='$opponent',lawyer='$lawyer',casedetails='$casedetails',courtname='$courtname',casetypeid='$casetypeid',casenumber='$casenumber',adate='$adate',cstatus='$cstatus' WHERE caseid='$caseid'";
		$query=$this->db->query($sql);
	}
	...
	public function cutting_insert($userid,$factoryid,$cqty,$cdate)
	{
		date_default_timezone_set('Asia/Dhaka');
		$cdate = date("Y-m-d", strtotime($cdate));
		//$d=date('Y-m-d');
		...
		{
		$sql="INSERT INTO cutting_qty VALUES ('$cid','$userid','$factoryid','$cqty','$cdate')";
		$query=$this->db->query($sql);
		return $query;
		}
	}
	public function sewing_insert($userid,$factoryid,$sqty,$sdate)
	{
		date_default_timezone_set('Asia/Dhaka');
		$sdate = date("Y-m-d", strtotime($sdate));
		//$d=date('Y-m-d');
		...
		{
		$sql="INSERT INTO sewing_qty VALUES ('$sewid','$userid','$factoryid','$sqty','$sdate')";
		$query=$this->db->query($sql);
		return $query;
		}
	}
	public function finishing_insert($userid,$factoryid,$fqty,$fdate)
	{
		date_default_timezone_set('Asia/Dhaka');
		...
		{
		$sql="INSERT INTO finishing_qty VALUES ('$fid','$userid','$factoryid','$fqty','$fdate')";
		$query=$this->db->query($sql);
		return $query;
		}
	}
...
//		$vtid=$d.$t;
	...
	public function mvmfuse_list($mo,$yr)
	{
		...
		$query="SELECT * FROM vreading_list_view
				...
				LEFT JOIN vfuel_insert ON vfuel_insert.vfuid=vfueluse_total_view.vfuelid
		 		WHERE vmonth='$mo' AND vyear='$yr' ORDER BY afuid ASC";
		$result=$this->db->query($query);
		return $result->result_array();
	}
...
//		$querym=$this->db->query($sqlm);
	...
	{
		$query="SELECT userid,SUM(marks) AS marks FROM examques1 JOIN examresult ON examresult.examans=examques1.exqusid";
		$result=$this->db->query($query);
		return $result->result_array();
	}
