												...
												<tbody>
													...
													?>
														<tr>
															...
															<td style="vertical-align:middle;"><a href="<?php echo base_url(); ?>Dashboard/product_details_list_up/<?php echo $bn = $row['pacode']; ?>"><i class="fa fa-edit" style="font-size:24px"></i></a></td>
