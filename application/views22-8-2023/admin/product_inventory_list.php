												...
												?>
                											<tr>
                                                                ...
                                                                <?php
																		...
																		{
																?>
                                                                			<td style="vertical-align:middle;"><a href="<?php echo base_url();?>Dashboard/product_assign_form/<?php echo $bn=$row['piv'];?>"><?php echo $row['pacode'];?></a></td>
                                                                <?php
																		}
																?>
                                                                <?php /*?><td style="vertical-align:middle;"><?php echo $row['pacode'];?></td><?php */?>
                                                                <td style="vertical-align:middle;"><?php echo $row['ifid'];?></td>
                                                                ...
                                                                <td style="vertical-align:middle;"><?php echo $row['supplier'];?></td>
                  												...
                  												<?php /*?><td style="vertical-align:middle;"><?php echo $row['brand'];?></td>
                                                                <td style="vertical-align:middle;"><?php echo $row['hdd'];?></td>
                                                                <td style="vertical-align:middle;"><?php echo $row['monitor'];?></td>
                                                                <td style="vertical-align:middle;"><?php echo $row['ups'];?></td><?php */?>
                                                                <?php /*?><td style="vertical-align:middle;"><?php echo $row['ip'];?></td><?php */?>
                                                                <?php /*?><td style="vertical-align:middle;"><?php echo $row['mb'];?></td><?php */?>
                                                                <td style="vertical-align:middle;"><?php echo $row['sn'];?></td>
                                                                <?php /*?><td style="vertical-align:middle;"><?php echo $row['processor'];?></td>
                                                                <td style="vertical-align:middle;"><?php echo $row['ram'];?></td>
                                                                <td style="vertical-align:middle;"><?php echo $row['os'];?></td>
                                                                <td style="vertical-align:middle;"><?php echo $row['ms'];?></td><?php */?>
                                                                <?php /*?><?php
																	if($row['avid']==1)
																		{
																?>
												...
												?>
                                                                ...
                                                                <?php
																	if($row['pastatus']==1)
																		{
																?>
                                                                <td style="vertical-align:middle;"><a href="<?php echo base_url();?>Dashboard/product_return_form/<?php echo $bn=$row['piv'];?>">Using</a></td>
                                                                <?php
																		}
																else
																		{
                                                                ...
                                                                <?php
                  												...
                  												<td style="vertical-align:middle;"><a href="<?php echo base_url();?>Dashboard/product_inventory_list_up/<?php echo $bn=$row['piv'];?>"><i class="fa fa-edit" style="font-size:24px"></i></a></td>
                                                                <td style="vertical-align:middle;"><a href="<?php echo base_url();?>Dashboard/product_transfer_form/<?php echo $bn=$row['piv'];?>"><i class="fa fa-exchange" aria-hidden="true"></i></a></td>
															</tr>
											</tbody>
												<?php 
													} 
