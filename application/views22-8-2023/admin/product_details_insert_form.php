               						...
               						<div class="box-body">
				 						<form role="form" autocomplete="off" action="<?php echo base_url();?>Dashboard/product_details_insert" method="post" enctype="multipart/form-data">
                  							<div class="form-group">
												<label>Code</label>
												<input type="text" class="form-control" readonly name="pcode" value="<?php echo $pd;?>">
												...
												<select class="form-control" name="psgid" id="psgid">
                        							...
                        							<?php
														foreach($sgl as $row)
															{
													?>
                    											<option value="<?php echo $row['psgid'];?>"><?php echo $row['psgname'];?></option>
                    								<?php
															}
													?>
                    							</select>
                                            ...
                                            <div class="form-group">
												<label>Price</label>
												<input type="text" class="form-control" name="pr" placeholder="Enter Price">
                    							<?php echo form_error('pr', '<div class="error">', '</div>');  ?>
											</div>
                                            <div class="form-group">
