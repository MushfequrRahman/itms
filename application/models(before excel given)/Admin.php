...
class Admin extends CI_Model
{
	...
	public function product_details_insert($pccode, $factoryid, $mpr, $brand, $hdd, $monitor, $ups, $ip, $mb, $sn, $processor, $ram, $os, $ms, $avid, $iid, $description, $price, $pqty, $puomid, $vendor, $pcapop, $warranty, $pdate)
	{
		...
		$pcode = $pccode . '-' . $pcode;
		$sql = "INSERT INTO product_details_insert VALUES ('','$pccode','$pcode','$mpr','$brand','$hdd','$monitor','$ups','$ip','$mb','$sn','$processor','$ram','$os','$ms','$avid','$iid','$description','$price','$pqty','$puomid','$vendor','$pcapop','$warranty','$pdate','','','','0')";
		$query = $this->db->query($sql);
...
//	}
	public function product_details_list()
	{
		$query = "SELECT pdiid,product_category_insert.pccode,product_details_insert.pcode,pcname,mpr,description,pqty,puom,warranty,pdate,pastatus,adate,product_details_insert.userid,name,image 
		FROM product_details_insert
		LEFT JOIN product_category_insert ON product_category_insert.pccode=product_details_insert.pccode
		LEFT JOIN product_uom_insert ON product_uom_insert.puomid=product_details_insert.puomid
		LEFT JOIN user ON user.userid=product_details_insert.userid";
	...
	public function producthistorylup($factoryid,$pcode)
	{
