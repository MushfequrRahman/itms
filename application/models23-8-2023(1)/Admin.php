...
class Admin extends CI_Model
{
	...
	public function product_details_list()
	{
		...
		mpr,sn,item,description,pqty,puom,warranty,price,pdate,adate,rdate,ddate,pcname,
	...
	public function product_dispose_insert($pacode, $remarks, $ddate)
	{
		$ddate = date("Y-m-d", strtotime($ddate));

		$sql = "UPDATE product_details_insert SET ddate='$ddate',dremarks='$remarks',pastatus='2' 
		WHERE pacode='$pacode'";
