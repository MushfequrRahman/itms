<aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
        	<a href="#">
            	<i class="fa fa-music" aria-hidden="true"></i><span>Material Movement</span>
            	<span class="pull-right-container">
              		<i class="fa fa-angle-left pull-right"></i>
            	</span>
          	</a>
          	<ul class="treeview-menu">
                ...
                <li><a href="<?php echo base_url();?>Dashboard/challan_list"><i class="fa fa-circle-o"></i>Challan List</a></li>
        ...
        <li class="treeview">
        	<a href="#">
            	<i class="fa fa-music" aria-hidden="true"></i><span>HR</span>
            	<span class="pull-right-container">
              		<i class="fa fa-angle-left pull-right"></i>
            	</span>
          	</a>
         ...
         <li class="treeview">
        	<a href="#">
          	...
          	<ul class="treeview-menu">
                ...
                <li><a href="<?php echo base_url();?>Dashboard/challan_create_form"><i class="fa fa-circle-o"></i>Challan Create</a></li>
                <li><a href="<?php echo base_url();?>Dashboard/factory_challan_list"><i class="fa fa-circle-o"></i>Factory Wise Challan List</a></li>
