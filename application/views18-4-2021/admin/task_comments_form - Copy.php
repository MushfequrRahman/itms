...
$(document).ready(function(){
    ...
    $('#submit').click(function(event){
        ...
        $.ajax({
			...
			dataType:"text",
                    data:{ assignerid:assignerid,assigneeid:assigneeid,createtaskid:createtaskid,assigneetlid:assigneetlid,taskcomments:taskcomments},
...
<div id="response"></div>
//$('#response').html('name : ' + taskcomments);
</body>
</html>
