            ...
            <div class="box-body table-responsive no-padding">
              ...
              <thead style="background:#91b9e6;">
                ...
                <tr>
                  ...
                  <td style="vertical-align:middle;"><a href="<?php echo base_url();?>Dashboard/buyer_imglist_up/<?php echo $bn=$row['buyername'];?>"><img class="profile-user-img img-responsive img-thumbnail" src="<?php echo base_url().'assets/uploads/buyer/'.$row['image'];?>" alt="User profile picture"></a></td>
                  ...
                  <td style="vertical-align:middle;"><a href="<?php echo base_url();?>Dashboard/buyer_list_up/<?php echo $bn=$row['buyername'];?>"><i class="fa fa-edit" style="font-size:24px"></i></a></td>
