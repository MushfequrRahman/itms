            ...
            <div class="col-md-12">
              ...
              <div class="box box-danger">
                <div class="box-header with-border">
                  <h3 class="box-title">Event Info Insert</h3>
					<div class="row">
                ...
                <!-- /.box-header -->
                <div class="box-body ">
				 <form role="form" autocomplete="off" action="<?php echo base_url();?>Dashboard/eventalbum_insert" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <?php echo form_error('eventname', '<div class="error">', '</div>');  ?>
				</div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <span>jpg|png(MAX Size 4 MB with 1024*768)</span>
				</div>
