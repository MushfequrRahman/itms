            ...
            <div class="col-md-12">
              ...
              <div class="box box-danger">
                <div class="box-header with-border">
                  <h3 class="box-title">License Tracker Insert</h3>
					<div class="row">
                ...
                <div class="box-body ">
				 <form role="form" autocomplete="off" action="<?php echo base_url();?>Dashboard/license_insert" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
					...
					<input type="text" class="form-control" name="licensename" placeholder="Enter License Name">
                    <?php echo form_error('licensename', '<div class="error">', '</div>');  ?>
				</div>
                <div class="form-group">
					<label>Regulatory Authority<em>*</em></label>
					<input type="text" class="form-control" name="reauthority" placeholder="Enter Regulatory Authority Name">
                ...
                <div class="form-group">
					...
					<select class="form-control" name="licensetypeid" id="licensetypeid">
                    	<option value="">Select....</option>
                        <?php
						foreach($alllt as $row)
						{
					?>
                    		<option value="<?php echo $row['licensetypeid'];?>"><?php echo $row['licensetype'];?></option>
                    <?php
						}
					?>
                    </select>
                    <?php echo form_error('licensetypeid', '<div class="error">', '</div>');  ?>
				</div>
				<div class="form-group">
					<label>Issue Date<em>*</em></label>
					<input type="text" class="form-control pd" name="issuedate" value="<?php echo date('d-m-Y');?>">
                    <?php /*?><?php echo form_error('dobdate', '<div class="error">', '</div>');  ?><?php */?>
				</div>
                <div class="form-group">
					<label>Next Renewal Date<em>*</em></label>
					<input type="text" class="form-control pd" name="renewaldate" value="<?php echo date('d-m-Y');?>">
                    <?php /*?><?php echo form_error('dobdate', '<div class="error">', '</div>');  ?><?php */?>
				</div>
				 <div class="form-group">
					<label>Processing Time<em>*</em></label>
					<input type="text" class="form-control" name="processtime" placeholder="Enter Processing Time">
                    <?php echo form_error('processtime', '<div class="error">', '</div>');  ?>
				</div>
				 <div class="form-group">
					<label>Regulatory Fee<em>*</em></label>
					<input type="text" class="form-control" name="regulatoryfee" placeholder="Enter Regulatory Fee">
                    <?php echo form_error('regulatoryfee', '<div class="error">', '</div>');  ?>
				</div>
                 <div class="form-group">
					<label>Mi. Exp<em>*</em></label>
					<input type="text" class="form-control" name="misexp" placeholder="Enter Mis.Exp">
                    <?php echo form_error('misexp', '<div class="error">', '</div>');  ?>
				</div>
                <div class="form-group">
                  <label for="licensefile">License Photo</label>
