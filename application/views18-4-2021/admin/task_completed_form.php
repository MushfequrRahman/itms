            ...
            <div class="col-md-12">
              ...
              <div class="box box-danger">
                <div class="box-header with-border">
                  <h3 class="box-title">Task Completed Info</h3>
					<div class="row">
                ...
                <div class="box-body ">
				 <form role="form" autocomplete="off" action="<?php echo base_url();?>Dashboard/task_completed_insert" method="post" enctype="multipart/form-data">
                 <input type="hidden" name="userid" value="<?php echo $this->session->userdata('userid');?>">
                 <input type="hidden" name="assigneetlid" value="<?php echo $assigneetlid;?>">
                ...
                <div class="form-group">
					...
					<input type="text" class="form-control" name="rating" placeholder="Give Ratings">
                ...
                <div class="form-group">
					<label>Completed Date<em>*</em></label>
					<input type="text" class="form-control pd" name="completeddate" value="<?php echo date('d-m-Y');?>">
