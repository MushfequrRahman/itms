            ...
            <div class="col-md-12">
              ...
              <div class="box box-danger">
                <div class="box-header with-border">
                  <h3 class="box-title">SWOT Pending List</h3>
					<div class="row">
            ...
            <div class="box-body table-responsive no-padding">
              ...
              <thead style="background:#91b9e6;">
                ...
                <tr>
                  ...
                  <td style="vertical-align:middle;"><a href="<?php echo base_url();?>Dashboard/swot_list_up/<?php echo $bn=$row['sid'];?>">Yes</a></td>
                  <td style="vertical-align:middle;"><a href="<?php echo base_url();?>Dashboard/swot_delete/<?php echo $bn=$row['sid'];?>">No</a></td>
