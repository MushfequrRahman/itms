             							...
             							<table id="tableData" class="table table-hover table-bordered">
                							...
                							<tbody>
                											...
                											<tr>
                                                                ...
                                                                <?php
																	if($row['pastatus']==1)
																		{
																?>
                  															<td style="vertical-align:middle;"><?php echo $row['piv'];?></td>
                                                                <?php
																		}
																	else
																		{
																?>
                                                                			<td style="vertical-align:middle;"><a href="<?php echo base_url();?>Dashboard/product_assign_form/<?php echo $bn=$row['piv'];?>"><?php echo $row['piv'];?></a></td>
                                                                <?php
																		}
																?>
												...
												?>
                                                                ...
                                                                <?php /*?><td style="vertical-align:middle;"><a href="<?php echo base_url();?>Dashboard/product_transfer_form/<?php echo $bn=$row['pdiid'];?>"><i class="fa fa-exchange" aria-hidden="true"></i></a></td><?php */?>
															</tr>
											</tbody>
												<?php 
													} 
