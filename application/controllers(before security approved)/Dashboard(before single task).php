		...
		if($this->input->post('submit'))
		{
			...
			if($this->form_validation->run()==FALSE)
			...
			else
				{
					...
					$ins=$this->Admin->useraccess_insert($userid,$bsre,$bswr,$tsre,$tswr,$lsre,$lswr,$nare,$nawr,$pare,$pawr,$eare,$eawr,$trre,$trwr,$swotre,$swotwr,$eore,$eowr,$mmre,$mmwr,$mmallure,$hrre,$hrwr,$care,$cawr,$capre,$capwr,$scre,$scwr,$dcre,$dcwr,$sbre,$sbwr);
...
//				{
					...
					$ins=$this->Admin->useraccesslup($userid,$bsre,$bswr,$tsre,$tswr,$lsre,$lswr,$nare,$nawr,$pare,$pawr,$eare,$eawr,$trre,$trwr,$swotre,$swotwr,$eore,$eowr,$mmre,$mmwr,$mmallure,$hrre,$hrwr,$care,$cawr,$capre,$capwr,$scre,$scwr,$dcre,$dcwr,$sbre,$sbwr);
...
//		$data['wd']=$wd;
		...
		$data['utl3']=$this->Admin->year_wise_individualsummarysscorecard3($userid,$year);
...
//				{
	...
	public function date_wise_sucomplete_list_form()
	 ...
	 public function date_wise_sucompletelist()
	 {
		...
		$pd = $this->input->post('pd');
		$wd = $this->input->post('wd');
		$data['utl']=$this->Admin->date_wise_sucompletelist($factoryid,$pd,$wd);
