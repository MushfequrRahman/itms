...
//        }
	...
	public function provision_period_send()
	{
		...
		$query="SELECT user.factoryid,userid,ename,departmentname,echilddesignation,doj,pperiod FROM user
				...
				WHERE pperiod_status='1' AND service_type!='3'";
		$result=$this->db->query($query);
		$result=$result->result_array();
	...
	public function case_court_send()
	{
        ...
        // Set email format to HTML
        $mail->isHTML(true);
		$query="SELECT DATEDIFF(hfdate,CURDATE()) AS remaining,case_insert.caseid,factoryid,casenumber,hfdate FROM case_insert 
