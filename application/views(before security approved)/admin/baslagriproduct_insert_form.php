          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <div class="box box-danger">
                ...
                <div class="box-body ">
				 <form role="form" autocomplete="off" action="<?php echo base_url();?>Dashboard/baslagriproduct_insert" method="post" enctype="multipart/form-data">
                 
                 
                <div class="form-group">
					<label>Parent ID<em>*</em></label>
                    <input type="text" name="pid" class="form-control" placeholder="Parent ID">
				</div> 
                <div class="form-group">
					<label>Item Name<em>*</em></label>
                    <input type="text" name="iname" class="form-control" placeholder="Item Name">
                    <?php echo form_error('iname', '<div class="error">', '</div>');  ?>
				</div>
               
				<div class="form-group">
					<label>Order Number<em>*</em></label>
                    <input type="text" name="onumber" class="form-control" placeholder="Order Number">
                    <?php echo form_error('onumber', '<div class="error">', '</div>');  ?>
				</div>
