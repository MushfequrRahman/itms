            ...
            <div class="box-body table-responsive no-padding">
              ...
              <thead style="background:#91b9e6;">
                <tr>
                  ...
                  <th>Buyer Name</th>
                  <th>License Name</th>
                  <?php /*?><th>Regulatory Authority</th><?php */?>
                 ...
                 <!-- <th>Division</th>
                  ...
                  <?php /*?><?php if($this->session->userdata('user_type')!=11)
				  {
					  ?>
				  ...
				  ?><?php */?>
                  <th>Status</th>
                  <?php /*?><?php if($this->session->userdata('user_type')==1)
				  {
					  ?>
                  <th>Edit</th>
                  <th>File Edit</th>
                ...
                <tr>
				 ...
				 ?>
                  ...
                  <td style="vertical-align:middle;"><?php echo $row['factid'];?></td>
                  ...
                  <?php /*?><td style="vertical-align:middle;"><?php echo $row['reauthority'];?></td><?php */?>
                  <?php /*?><td style="vertical-align:middle;"><?php echo $row['divisionname'];?></td>
                  <td style="vertical-align:middle;"><?php echo $row['departmentname'];?></td><?php */?>
                  <?php /*?><td style="vertical-align:middle;"><?php echo $row['licensetype'];?></td><?php */?>
                  <?php
				  $row['issuedate'];
