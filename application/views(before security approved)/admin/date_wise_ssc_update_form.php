            ...
            <div class="col-md-12">
              ...
              <div class="box box-danger">
                <div class="box-header with-border">
                  <h3 class="box-title">Sewing Supervisor List</h3>
					<div class="row">
                ...
                <div class="form-group">
					...
					<input type="text" class="form-control pd" name="cdate" id="pd" value="<?php echo date('d-m-Y'); ?>">
				</div>
               </div>
                <!-- /.box-body -->
    ...
    $(document).ready(function(){
        $( "#btn" ).click(function(event)
        {
            ...
            $.ajax(
                {
                    type:'post',
                    url: '<?php echo base_url(); ?>Dashboard/factorywise_ssupervisor_list_update',
					dataType:"text",
                    data:{ factoryid:factoryid,pd:pd},
