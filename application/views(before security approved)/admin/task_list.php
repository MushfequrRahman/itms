            ...
            <div class="box-body table-responsive no-padding">
              ...
              <thead style="background:#91b9e6;">
                ...
                <tr>
				  ...
				  {
					  ?>
                  <td style="vertical-align:middle; background:#FF6; color:#fff;font-weight:bold;"><?php echo $cdeadlinedate;?></td>
                  <?php
				  }
				  elseif(date('Y-m-d') > $row['cdeadlinedate'])
				  {
				  ?>
                  <td style="vertical-align:middle; background: #900; color:#fff;font-weight:bold;"><?php echo $cdeadlinedate;?></td>
                  <?php
				  }
                  elseif($prevday)
				  {
				  ?>
                  <td style="vertical-align:middle; background: #F90; color:#fff;font-weight:bold;"><?php echo $cdeadlinedate;?></td>
                  <?php
				  }
				  else
				  {
