            ...
            <div class="col-md-12">
              ...
              <div class="box box-danger">
                <div class="box-header with-border">
                  <h3 class="box-title">Cap File Upload</h3>
					<div class="row">
                ...
                <!-- /.box-header -->
				 ...
				 <form role="form" id="comment" autocomplete="off" action="<?php echo base_url();?>Dashboard/capfile_upload" method="post" enctype="multipart/form-data">
                <div class="box-body ">
