            ...
            <div class="col-md-12">
              ...
              <div class="box box-danger">
                <div class="box-header with-border">
                  <h3 class="box-title">Policy Type Name</h3>
					<div class="row">
                ...
                <div class="box-body ">
				 <form role="form" autocomplete="off" action="<?php echo base_url();?>Dashboard/policy_type_insert" method="post" enctype="multipart/form-data">
				...
				<div class="form-group">
					<label>Policy Type<em>*</em></label>
					 <input type="text" class="form-control"  name="policytype" placeholder="Policy Type Name">
                    <?php echo form_error('policytype', '<div class="error">', '</div>');  ?>
				</div>
