            ...
            <div class="col-md-12">
              ...
              <div class="box box-danger">
                <div class="box-header with-border">
                  <h3 class="box-title">Info Insert</h3>
					<div class="row">
                ...
                <!-- /.box-header -->
                <div class="box-body ">
				 <form role="form" autocomplete="off" action="<?php echo base_url();?>Dashboard/intern_tracking_insert" method="post" enctype="multipart/form-data">
                 ...
                 <div class="form-group">
					...
					<input type="text" class="form-control pd" name="sdate" value="<?php echo date('d-m-Y');?>">
                ...
                <div class="form-group">
					<label>Duration (Month)<em>*</em></label>
					<input type="text" class="form-control pd" name="duration" placeholder="Enter Days">
                    
				</div>
                 <div class="form-group">
					<label>Major Subject<em>*</em></label>
                    <input type="text" class="form-control" name="msubject" placeholder="Major Subject">
                 </div>
                 <div class="form-group">
					<label>University<em>*</em></label>
                    <input type="text" class="form-control" name="uni" placeholder="University">
                 </div>
                 <div class="form-group">
                ...
                <div class="form-group">
					...
					<input type="text" class="form-control pd" name="rdate" value="<?php echo date('d-m-Y');?>">
                    
				</div>
                <div class="form-group">
					<label>Thesis Submission Date<em>*</em></label>
					<input type="text" class="form-control pd" name="tsdate" value="<?php echo date('d-m-Y');?>">
                    
				</div>
                <div class="form-group">
					<label>Internship Certificate Issuse Date<em>*</em></label>
					<input type="text" class="form-control pd" name="icidate" value="<?php echo date('d-m-Y');?>">
