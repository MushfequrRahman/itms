          ...
          <div class="row">
            ...
            <div class="scrollable-table-wrapper">
                ...
                <tr>
                  ...
                  <th>Origin</th>
                  <th>Local Address</th>
                  <th>Name(Local Compliance Contact Person)</th>
                  <th>Mobile(Local Compliance Contact Person)</th>
                  <th>Email(Local Compliance Contact Person)</th>
                  <th>Name(Local Merchandiser Contact Person)</th>
                  <th>Mobile(Local Merchandiser Contact Person)</th>
                  <th>Email(Local Merchandiser Contact Person)</th>
                  <th>Web</th>
                  <th>Edit</th>
                </tr>
                </thead>
                ...
                <tr>
                  ...
                  <td style="vertical-align:middle;"><a href="<?php echo base_url();?>Dashboard/buyer_imglist_up/<?php echo $bn=$row['bid'];?>"><img class="profile-user-img img-responsive img-thumbnail" src="<?php echo base_url().'assets/uploads/buyer/'.$row['image'];?>" alt="User profile picture"></a></td>
                  <td style="vertical-align:middle;"><a href="<?php echo base_url();?>Dashboard/buyer_list_details/<?php echo $bn=$row['bid'];?>"><?php echo $row['buyername'];?></a></td>
                  ...
                  <td style="vertical-align:middle;"><a href="<?php echo base_url();?>Dashboard/buyer_list_up/<?php echo $bn=$row['bid'];?>"><i class="fa fa-edit" style="font-size:24px"></i></a></td>
