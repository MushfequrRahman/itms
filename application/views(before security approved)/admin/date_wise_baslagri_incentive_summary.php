						...
						if($row['productid']==10)
								{
									...
									@$p10=(round(($row['salesach']/$row['collectionach']),2)*100);
								}
						if($row['productid']==11)
								{
            						//@$p11=(round(($row['salesach']/$row['tamount']),2)*100);
									@$p11=(round(($row['salesach']/$row['collectionach']),2)*100);
								}
						if($row['productid']==12)
								{
            						//@$p12=(round(($row['salesach']/$row['tamount']),2)*100);
									@$p12=(round(($row['salesach']/$row['collectionach']),2)*100);
								}
						if($row['productid']==13)
								{
            						//@$p13=(round(($row['salesach']/$row['tamount']),2)*100);
									@$p13=(round(($row['salesach']/$row['collectionach']),2)*100);
								}
							...
							for($j=0; $j < count($productid); $j++) 
								{
									...
									//if($userIDD =="HO11")
//									{
										//if($row['productid']=='10' || $row['productid']=='11' || $row['productid']=='12' || $row['productid']=='13')
										if($productid[$j]=='10' || $productid[$j]=='11' || $productid[$j]=='12' || $productid[$j]=='13')
										{
