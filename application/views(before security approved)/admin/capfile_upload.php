            ...
            <div class="modal-body">
              ...
              <thead style="background:#91b9e6;">
                ...
                <tr>
                  ...
                  <input type="hidden" class="form-control" name="buyername" value="<?php echo $row['bid'];?>">
                  <input type="hidden" class="form-control" name="audittype" value="<?php echo $row['apid'];?>">
                  ...
                  <td style="vertical-align:middle;"><?php echo date("d-m-Y", strtotime($row['auditdate']));?></td>
