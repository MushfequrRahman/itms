      ...
      <ul class="sidebar-menu" data-widget="tree">
          	...
          	<ul class="treeview-menu">
            	<li class="treeview">
        			<a href="#">
          			...
          			<ul class="treeview-menu">
                        ...
                        <li><a href="<?php echo base_url();?>Dashboard/buyerwf_insert_form"><i class="fa fa-circle-o"></i> Add Buyer With Factory Info</a></li>
                        <li><a href="<?php echo base_url();?>Dashboard/buyerwf_list"><i class="fa fa-circle-o"></i>Buyer Wise Factory List</a></li>
                        <li><a href="<?php echo base_url();?>Dashboard/buyerwcer_insert_form"><i class="fa fa-circle-o"></i> Add Certificate Info</a></li>
                        <li><a href="<?php echo base_url();?>Dashboard/buyerwcer_list"><i class="fa fa-circle-o"></i> Buyer Certificate List</a></li>
            		</ul>
       			</li>
            	<li class="treeview">
        			<a href="#">
                ...
                <li class="treeview">
        			<a href="#">
          			...
          			<ul class="treeview-menu">
            			<li><a href="<?php echo base_url();?>Dashboard/useraccess_insert_form"><i class="fa fa-circle-o"></i> Add User Access</a></li>
                		<li><a href="<?php echo base_url();?>Dashboard/useraccess_update_form"><i class="fa fa-circle-o"></i>User Access Update</a></li>
            		</ul>
        		</li>
                <li class="treeview">
        			<a href="#">
          	...
          	<ul class="treeview-menu">
                ...
                <li class="treeview">
        			<a href="#">
          			...
          			<ul class="treeview-menu">
            			<li><a href="<?php echo base_url();?>Dashboard/useraccess_insert_form"><i class="fa fa-circle-o"></i> Add User Access</a></li>
                		<li><a href="<?php echo base_url();?>Dashboard/useraccess_list"><i class="fa fa-circle-o"></i>User Access List</a></li>
            		</ul>
        		</li>
                <li class="treeview">
        			<a href="#">
        ...
        <li class="treeview">
        	<a href="#">
          	...
          	<ul class="treeview-menu">
            	<li><a href="<?php echo base_url();?>Dashboard/createtask_insert_form"><i class="fa fa-circle-o"></i> Add Group Task Tracker Info</a></li>
                <li><a href="<?php echo base_url();?>Dashboard/screatetask_insert_form"><i class="fa fa-circle-o"></i> Add Single Task Tracker Info</a></li>
        ...
        <li class="treeview">
        	<a href="#">
          	...
          	<ul class="treeview-menu">
                ...
                <li><a href="<?php echo base_url();?>Dashboard/licensename_insert_form"><i class="fa fa-circle-o"></i>Add License Name</a></li>
                <li><a href="<?php echo base_url();?>Dashboard/licensename_list"><i class="fa fa-circle-o"></i>License Name List</a></li>
            </ul>
        </li>
        <?php
		}
        	...
        	<a href="#">
          	...
          	<ul class="treeview-menu">
                ...
                <li><a href="<?php echo base_url();?>Dashboard/policy_list"><i class="fa fa-circle-o"></i>Policy Album list</a></li>
               	<li><a href="<?php echo base_url();?>Dashboard/policy_type_form"><i class="fa fa-circle-o"></i>Add Policy Type</a></li>
                <li><a href="<?php echo base_url();?>Dashboard/policy_type_list"><i class="fa fa-circle-o"></i>Policy Type list</a></li>
                <li><a href="<?php echo base_url();?>Dashboard/policy_class_form"><i class="fa fa-circle-o"></i>Add Policy Class</a></li>
                <li><a href="<?php echo base_url();?>Dashboard/policy_class_list"><i class="fa fa-circle-o"></i>Policy Class list</a></li>
            </ul>
        </li>
        <?php
		}
        ...
        <li class="treeview">
        	<a href="#">
          	...
          	<ul class="treeview-menu">
                ...
                <li><a href="<?php echo base_url();?>Dashboard/trainingscope_insert_form"><i class="fa fa-circle-o"></i>Training Scope</a></li>
                <li><a href="<?php echo base_url();?>Dashboard/trainingscope_list"><i class="fa fa-circle-o"></i>Training Scope List</a></li>
                <li><a href="<?php echo base_url();?>Dashboard/traininggroup_insert_form"><i class="fa fa-circle-o"></i>Training Group</a></li>
                <li><a href="<?php echo base_url();?>Dashboard/traininggroup_list"><i class="fa fa-circle-o"></i>Training Group List</a></li>
                <li><a href="<?php echo base_url();?>Dashboard/trainingtopic_insert_form"><i class="fa fa-circle-o"></i>Training Topic</a></li>
                <li><a href="<?php echo base_url();?>Dashboard/trainingtopic_list"><i class="fa fa-circle-o"></i>Training Topic List</a></li>
                <li><a href="<?php echo base_url();?>Dashboard/trainingtp_insert_form"><i class="fa fa-circle-o"></i>Add Topic</a></li>
                <li><a href="<?php echo base_url();?>Dashboard/trainingtp_list"><i class="fa fa-circle-o"></i>Topic List</a></li>
            </ul>
        </li>
        <?php
		}
        ...
        <li class="treeview">
        	<a href="#">
          	...
          	<ul class="treeview-menu">
            	...
            	<?php /*?><li><a href="<?php echo base_url();?>Dashboard/eobservation_insert_form"><i class="fa fa-circle-o"></i>Add Observation Info</a></li><?php */?>
                <li><a href="<?php echo base_url();?>Dashboard/eobservation_pending_list"><i class="fa fa-circle-o"></i>Observation Pending List</a></li>
                <li><a href="<?php echo base_url();?>Dashboard/euser_observation_form"><i class="fa fa-circle-o"></i>User Observation List</a></li>
        ...
        <li class="treeview">
        	<a href="#">
          	...
          	<ul class="treeview-menu">
                ...
                <li><a href="<?php echo base_url();?>Dashboard/date_wise_allunit_challan_list_form"><i class="fa fa-circle-o"></i>Challan List</a></li>
        ...
        <li class="treeview">
        	<a href="#">
          	...
          	<ul class="treeview-menu">
            	<li><a href="<?php echo base_url();?>Dashboard/auditrp_insert_form"><i class="fa fa-circle-o"></i> Add Responsible Person</a></li>
                <li><a href="<?php echo base_url();?>Dashboard/auditrp_list"><i class="fa fa-circle-o"></i>Audit Responsible Person list</a></li>
        ...
        <li class="treeview">
        			<a href="#">
          			...
          			<ul class="treeview-menu">
                        ...
                        <li><a href="<?php echo base_url();?>Dashboard/date_wise_individualssc_form"><i class="fa fa-circle-o"></i>Individual Sewing SC</a></li>
                        <li><a href="<?php echo base_url();?>Dashboard/year_wise_individualssc_form"><i class="fa fa-circle-o"></i>Yearly Individual Sewing SC</a></li>
                        <li><a href="<?php echo base_url();?>Dashboard/date_wise_ssc_update_form"><i class="fa fa-circle-o"></i>Date Wise Update SC</a></li>
                        <li><a href="<?php echo base_url();?>Dashboard/sscorecard_import_excel"><i class="fa fa-circle-o"></i> Add From Excel</a></li>
            		</ul>
        </li>
        <?php
		}
        ...
        <li class="treeview">
        			<a href="#">
          			...
          			<ul class="treeview-menu">
                        ...
                        <li><a href="<?php echo base_url();?>Dashboard/add_dcadisposal_form"><i class="fa fa-circle-o"></i>ADD Disposal Type</a></li>
                        <li><a href="<?php echo base_url();?>Dashboard/dcadistype_list"><i class="fa fa-circle-o"></i>Disposal Type List</a></li>
            		</ul>
        </li>
        <?php
		}
        ...
        <li class="treeview">
        			<a href="#">
          			...
          			<ul class="treeview-menu">
                        ...
                        <li><a href="<?php echo base_url();?>Dashboard/date_wise_susummary_list_form"><i class="fa fa-circle-o"></i>Summary List</a></li>
       ...
       <?php
        ...
        <li class="treeview">
        			<a href="#">
          			...
          			<ul class="treeview-menu">
            			<li><a href="<?php echo base_url();?>Dashboard/cutting_insert_form"><i class="fa fa-circle-o"></i>Add Cutting Info</a></li>
                        <li><a href="<?php echo base_url();?>Dashboard/date_wise_cutting_report_form"><i class="fa fa-circle-o"></i>Date Wise Cutting Report</a></li>
                        <li><a href="<?php echo base_url();?>Dashboard/sewing_insert_form"><i class="fa fa-circle-o"></i>Add Sewing Info</a></li>
                        <li><a href="<?php echo base_url();?>Dashboard/date_wise_sewing_report_form"><i class="fa fa-circle-o"></i>Date Wise Sewing Report</a></li>
                        <li><a href="<?php echo base_url();?>Dashboard/finishing_insert_form"><i class="fa fa-circle-o"></i>Add Finishing Info</a></li>
                        <li><a href="<?php echo base_url();?>Dashboard/date_wise_finishing_report_form"><i class="fa fa-circle-o"></i>Date Wise Finishing Report</a></li>
            		</ul>
        </li>
       <?php
		}
        ...
        <li class="treeview">
        			<a href="#">
          			...
          			<ul class="treeview-menu">
                        ...
                        <li><a href="<?php echo base_url();?>Dashboard/vehicle_list"><i class="fa fa-circle-o"></i>Vehicle List</a></li>
                        <li><a href="<?php echo base_url();?>Dashboard/vinsurance_insert_form"><i class="fa fa-circle-o"></i>Add Insurance Info</a></li>
                        <li><a href="<?php echo base_url();?>Dashboard/vinsurance_list"><i class="fa fa-circle-o"></i>Insurance List</a></li>
                        <li><a href="<?php echo base_url();?>Dashboard/vtaxtoken_insert_form"><i class="fa fa-circle-o"></i>Add Tax Token Info</a></li>
                        <li><a href="<?php echo base_url();?>Dashboard/vtaxtoken_list"><i class="fa fa-circle-o"></i>Tax Token List</a></li>
                        <li><a href="<?php echo base_url();?>Dashboard/vfitness_insert_form"><i class="fa fa-circle-o"></i>Add Fitness Info</a></li>
                        <li><a href="<?php echo base_url();?>Dashboard/vfitness_list"><i class="fa fa-circle-o"></i>Fitness List</a></li>
                        <li><a href="<?php echo base_url();?>Dashboard/vfuel_insert_form"><i class="fa fa-circle-o"></i>Add Fuel Info</a></li>
                        <li><a href="<?php echo base_url();?>Dashboard/vfuel_list"><i class="fa fa-circle-o"></i>Fuel List</a></li>
                        <li><a href="<?php echo base_url();?>Dashboard/vroute_insert_form"><i class="fa fa-circle-o"></i>Add Route Info</a></li>
                        <li><a href="<?php echo base_url();?>Dashboard/vroute_list"><i class="fa fa-circle-o"></i>Route List</a></li>
                        <li><a href="<?php echo base_url();?>Dashboard/vehiclel_list"><i class="fa fa-circle-o"></i>Vehicle License List</a></li>
            		</ul>
        </li>
       <?php
		}
       ...
       <?php
        ...
        <li class="treeview">
        			<a href="#">
          			...
          			<ul class="treeview-menu">
            			<li><a href="<?php echo base_url();?>Dashboard/idea_insert_form"><i class="fa fa-circle-o"></i>Add Idea</a></li>
                        <li><a href="<?php echo base_url();?>Dashboard/date_wise_idea_list_form"><i class="fa fa-circle-o"></i>Idea List</a></li>
                        <li><a href="<?php echo base_url();?>Dashboard/ideagroup_insert_form"><i class="fa fa-circle-o"></i>Add Group</a></li>
                        <li><a href="<?php echo base_url();?>Dashboard/ideagroup_list"><i class="fa fa-circle-o"></i>Group List</a></li>
            		</ul>
        </li>
       <?php
		}
       ...
       <?php
        ...
        <li class="treeview">
        			<a href="#">
          			...
          			<ul class="treeview-menu">
            			<li><a href="<?php echo base_url();?>Dashboard/od_insert_form"><i class="fa fa-circle-o"></i>Add Message</a></li>
                        <li><a href="<?php echo base_url();?>Dashboard/od_list"><i class="fa fa-circle-o"></i>Message List</a></li>
                    </ul>
        </li>
       <?php
		}
        ...
        <li class="treeview">
        			<a href="#">
          			...
          			<ul class="treeview-menu">
            			<li><a href="<?php echo base_url();?>Dashboard/bloodgroup_insert_form"><i class="fa fa-circle-o"></i>Add Blood Group</a></li>
                        <li><a href="<?php echo base_url();?>Dashboard/bloodgroup_list"><i class="fa fa-circle-o"></i>Blood Group List</a></li>
                    </ul>
        </li>
       <?php
		}
        ...
        <li class="treeview">
        			<a href="#">
          			...
          			<ul class="treeview-menu">
            			<?php /*?><li><a href="<?php echo base_url();?>Dashboard/bloodg_insert_form"><i class="fa fa-circle-o"></i>Add Blood Group</a></li><?php */?>
                        <li><a href="<?php echo base_url();?>Dashboard/bloodgroup_list"><i class="fa fa-circle-o"></i>Blood Group List</a></li>
                    </ul>
        </li>
       <?php
        ...
        <li class="treeview">
        			<a href="#">
          			...
          			<ul class="treeview-menu">
                        ...
                        <li><a href="<?php echo base_url();?>Dashboard/talentpool_insert_form"><i class="fa fa-circle-o"></i>Add Talent Pool</a></li>
                        <li><a href="<?php echo base_url();?>Dashboard/talentpool_list"><i class="fa fa-circle-o"></i>Talent Pool List</a></li>
                    </ul>
        </li>
         <?php
		}
