          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <div class="box box-danger">
                ...
                <!-- /.box-header -->
                <div class="box-body ">
				 <form role="form" autocomplete="off" action="<?php echo base_url();?>Dashboard/information_collect_insert" method="post" enctype="multipart/form-data">
                 ...
                 <h3 class="text-center">Information Collect</h3>
                 <div class="form-group">
                 ...
                 <div class="form-group">
					<label>Present Factory<em>*</em></label>
                    <input type="text" class="form-control" name="pfactory" placeholder="Present Factory">
                 </div>
                 <div class="form-group">
