            ...
            <div class="col-md-12">
              ...
              <div class="box box-danger">
                <div class="box-header with-border">
                  <h3 class="box-title">Fitness Info Insert</h3>
					<div class="row">
                ...
                <div class="box-body ">
				 <form role="form" autocomplete="off" action="<?php echo base_url();?>Dashboard/vfitness_insert" method="post" enctype="multipart/form-data">
                 <div class="form-group">
					<label>Fitness Number<em>*</em></label>
                 	<input type="text" class="form-control" name="fitness" placeholder="Fitness Number">
