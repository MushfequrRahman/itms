            ...
            <div class="col-md-12">
              ...
              <div class="box box-danger">
                <div class="box-header with-border">
                  <h3 class="box-title">Challanges Member</h3>
					<div class="row">
                ...
                <div class="box-body ">
				 ...
				 <form role="form" autocomplete="off" action="<?php echo base_url();?>Dashboard/challanges_member_insert" method="post" enctype="multipart/form-data">
                 <?php /*?><input type="hidden" name="userid" value="<?php echo $this->session->userdata('userid');?>"><?php */?>
                 <div class="form-group">
					<label>ID<em>*</em></label>
					 <input type="text" class="form-control" readonly name="chid" value="<?php echo $chid;?>">
                    
				 </div>
                 <div class="form-group">
					<label>Member ID<em>*</em></label>
					 <input type="text" class="form-control" name="mid" placeholder="Enter User ID">
