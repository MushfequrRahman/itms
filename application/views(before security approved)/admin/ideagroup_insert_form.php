            ...
            <div class="col-md-12">
              ...
              <div class="box box-danger">
                <div class="box-header with-border">
                  <h3 class="box-title">Idea Group Name</h3>
					<div class="row">
                ...
                <div class="box-body ">
				 <form role="form" autocomplete="off" action="<?php echo base_url();?>Dashboard/ideagroup_insert" method="post" enctype="multipart/form-data">
				...
				<div class="form-group">
					<label>Group Name<em>*</em></label>
					 <input type="text" class="form-control"  name="ideagroup" placeholder="Idea Group Name">
                    <?php echo form_error('ideagroup', '<div class="error">', '</div>');  ?>
				</div>
