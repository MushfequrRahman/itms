...
$(document).ready(function(){
	...
	newTextBoxDiv.after().html(
	      '<div class="row"><table class="table table-bordered table-striped text-center"><tr><td><input type="text" class="form-control" readonly  name="sl[]' + counter + 
	      '" id="sl' + counter + '" value="' + counter +'" ></td>'+'<td><input type="text" class="form-control" name="ans[]' + counter + 
            ...
            <div class="col-md-12">
              ...
              <div class="box box-danger">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="exq" id="exq" placeholder="Exam Question">
					<?php echo form_error('exq', '<div class="error">', '</div>');  ?>
				</div>
                <div id="AuGroup">
									<div class="row">
                                    	<h4 class="text-center">Exam Answer & Marks</h4>
											<table class="table table-bordered table-striped text-center">
												...
												<tr>
                                                	<td><input type="text" class="form-control" readonly name="sl[]" id="sl" value="1"></td>
													<td><input type="text" class="form-control" name="ans[]" id="ans" placeholder="Answer">
														<?php echo form_error('ans[]', '<div class="error">', '</div>');  ?>
													</td>
                                                    <td><input type="text" class="form-control" name="marks[]" id="marks" placeholder="Marks">
