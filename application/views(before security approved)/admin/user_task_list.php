            ...
            <div class="box-body table-responsive no-padding">
              ...
              <thead style="background:#91b9e6;">
                ...
                <tr>
                  ...
                  <td style="vertical-align:middle;"><a href="<?php echo base_url();?>Dashboard/user_allontask/<?php echo $bn=$row['userid'];?>"><?php echo $row['userid'];?></a></td>
                  ...
                  <td style="vertical-align:middle;"><a href="<?php echo base_url();?>Dashboard/user_task_list_summary/<?php echo $bn=$row['userid'];?>"><i class="fa fa-list-alt"></i></a></td>
                </tbody>
               <?php } ?>
              </table>
            </div>
