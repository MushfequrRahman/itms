            ...
            <div class="col-md-12">
              ...
              <div class="box box-danger">
                <div class="box-header with-border">
                  <h3 class="box-title">Sales Collection Target Insert</h3>
					<div class="row">
                ...
                <div class="box-body ">
				 <form role="form" autocomplete="off" action="<?php echo base_url();?>Dashboard/baslagrisctarget_insert" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="ta" class="form-control" placeholder="Target Amount">
				</div>
                <div class="form-group">
					<label>Collection Target<em>*</em></label>
                    <input type="text" name="cta" class="form-control" placeholder="Target Amount">
				</div>
			</div>
                <!-- /.box-body -->
