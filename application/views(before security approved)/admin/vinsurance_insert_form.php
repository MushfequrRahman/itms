            ...
            <div class="col-md-12">
              ...
              <div class="box box-danger">
                <div class="box-header with-border">
                  <h3 class="box-title">Insurance Info Insert</h3>
					<div class="row">
                ...
                <div class="box-body ">
				 <form role="form" autocomplete="off" action="<?php echo base_url();?>Dashboard/vinsurance_insert" method="post" enctype="multipart/form-data">
                 <div class="form-group">
					<label>Insurance Number<em>*</em></label>
                 	<input type="text" class="form-control" name="insurance" placeholder="Insurance Number">
                	<?php echo form_error('insurance', '<div class="error">', '</div>');  ?>
				</div>
                 <div class="form-group">
