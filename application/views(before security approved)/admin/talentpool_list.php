            ...
            <div class="col-md-12">
              ...
              <div class="box box-danger">
                <div class="box-header with-border">
                  <h3 class="box-title">Talent Pool List</h3>
					<div class="row">
            ...
            <div class="box-body table-responsive no-padding">
              ...
              <thead style="background:#91b9e6;">
                ...
                <tr>
                  ...
                  <td style="vertical-align:middle;"><?php echo $row['fileno'];?></td>
                  <?php 
				 if($row['cvfile']=='')
                 {
					 ?>
				 ...
				 {
					 ?>
                     <td style="vertical-align:middle;"><a target="_blank" href="<?php echo base_url().'assets/uploads/talentpool/'.$row['cvfile'];?>"><i class="fa fa-file"></i></a></td>
                     <?php
				 }
				 ?>
                 <?php 
                 ...
                 {
					 ?>
                 <td style="vertical-align:middle;">Not Recruited</td>
                 <?php
				 }
				 else
				 {
					 ?>
                     <td style="vertical-align:middle;">Recruited</td>
                     <?php
				 }
				 ?>
                  <td style="vertical-align:middle;"><a href="<?php echo base_url();?>Dashboard/talentpool_list_up/<?php echo $bn=$row['talentpoolid'];?>"><i class="fa fa-edit" style="font-size:24px"></i></a></td>
