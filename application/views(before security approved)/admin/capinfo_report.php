            ...
            <div class="modal-body">
              ...
              <thead style="background:#91b9e6;">
                ...
                <tr>
                  ...
                  <td style="vertical-align:middle;"><input type="checkbox" class="chk" name="chpreaid[]" value="<?php echo $row['preaid'];?>"></td>
                  ...
                  <td style="vertical-align:middle;"><select class="form-control" name="pr[]" id="pr">
						...
						{
					?>
                    		<option value="<?php echo $row['auditrpid'];?>"><?php echo $row['ename'];?></option>
                    <?php
						}
					?>
                    </select>
                  ...
                  <!--<label for="preauitfile">File</label>-->
