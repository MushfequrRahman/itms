            ...
            <div class="col-md-12">
              ...
              <div class="box box-danger">
                <div class="box-header with-border">
                  <h3 class="box-title">Sales Collection Achievement Insert</h3>
					<div class="row">
                ...
                <div class="box-body ">
				 <form role="form" autocomplete="off" action="<?php echo base_url();?>Dashboard/baslagricachievement_insert" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
					<label>Achievement<em>*</em></label>
                    <input type="text" name="aa" class="form-control" placeholder="Achievement Amount">
				</div>
			</div>
                <!-- /.box-body -->
