            ...
            <div class="col-md-12">
              ...
              <div class="box box-danger">
                <div class="box-header with-border">
                  <h3 class="box-title">Date Wise Suggestion List</h3>
					<div class="row">
                ...
                <!-- /.box-header -->
                <div class="box-body ">
                <?php if($this->session->userdata('user_type')==1 || $this->session->userdata('user_type')==11)
				{
					?>
				...
				{
				?>
                <input type="hidden" class="form-control"  id="factoryid" value="<?php echo $this->session->userdata('factoryid');?>">
                <?php
				}
				?>
                	<div class="form-group">
    ...
    $(document).ready(function(){
        $( "#btn" ).click(function(event)
        {
            ...
            $.ajax(
                {
                    type:'post',
                    url: '<?php echo base_url(); ?>Dashboard/date_wise_sucompletelist',
					dataType:"text",
                    data:{ factoryid:factoryid,pd:pd,wd:wd},
