          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <thead style="background:#91b9e6;">
			   ...
			   ?>
               <tr>
               <td colspan="10" style="vertical-align:middle;"><strong>Total:</strong></td>
               <td style="vertical-align:middle;"><strong><?php echo $tsqty;?></strong></td>
               <td style="vertical-align:middle;"><strong><?php echo $trqty;?></strong></td>
               </tr>
              </table>
