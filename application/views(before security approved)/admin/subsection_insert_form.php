            ...
            <div class="col-md-12">
              ...
              <div class="box box-danger">
                <div class="box-header with-border">
                  <h3 class="box-title">Sub Section Insert</h3>
					<div class="row">
                ...
                <!-- /.box-header -->
                <div class="box-body ">
				 <form role="form" autocomplete="off" action="<?php echo base_url();?>Dashboard/subsection_insert" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
					...
					<input type="text" class="form-control" name="subsection" placeholder="Enter Sub Section">
                    <?php echo form_error('subsubsection', '<div class="error">', '</div>');  ?>
				</div>
