            ...
            <div class="col-md-12">
              ...
              <div class="box box-danger">
                <div class="box-header with-border">
                  <h3 class="box-title">Idea Insert</h3>
					<div class="row">
                ...
                <div class="box-body ">
				 <form role="form" autocomplete="off" action="<?php echo base_url();?>Dashboard/idea_insert" method="post" enctype="multipart/form-data">
                 <input type="hidden" name="userid" value="<?php echo $this->session->userdata('userid');?>">
                 
                 
                <div class="form-group">
					<label>Group Name<em>*</em></label>
					<select class="form-control" name="igid" id="igid">
                    	<option value="">Select....</option>
                        <?php
						foreach($ul as $row)
						{
					?>
                    		<option value="<?php echo $row['igid'];?>"><?php echo $row['ideagroup'];?></option>
                    <?php
						}
					?>
                    </select>
                    <?php echo form_error('igid', '<div class="error">', '</div>');  ?>
				</div>
               
				<div class="form-group">
					<label>Idea<em>*</em></label>
					 <textarea class="form-control"  name="idea" rows="5" id="idea"></textarea>
                    <?php echo form_error('idea', '<div class="error">', '</div>');  ?>
				</div>
