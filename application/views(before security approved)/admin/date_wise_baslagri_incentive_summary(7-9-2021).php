            ...
            <div class="box-body table-responsive no-padding">
              ...
              <thead style="background:#91b9e6;">
                ...
                <tr>
                  ...
                  <td style="vertical-align:middle;"><?php echo (round(($row['salesach']/$row['tamount']),2)*100)."%";?></td>
                  <td style="vertical-align:middle;"><?php echo $row['tcamount'];?></td>
                  <td style="vertical-align:middle;"><?php echo $row['collectionach'];?></td>
                  <td style="vertical-align:middle;"><?php echo (round(($row['collectionach']/$row['tcamount']),2)*100)."%";?></td>
                  <?php /*?><td style="vertical-align:middle;"><?php echo date("d-m-Y", strtotime($row['acdate']));?></td><?php */?>
                  <?php /*?><?php
