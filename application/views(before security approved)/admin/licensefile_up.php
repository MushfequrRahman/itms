        ...
        <div class="col-md-12">
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              <li class="active"><a href="#activity" data-toggle="tab">License File</a></li>
            ...
            <div class="tab-content">
              <div class="active tab-pane" id="activity">
               ...
               <?php foreach($elup as $row)
				{ ?>
              <form role="form" action="<?php echo base_url();?>Dashboard/licensefilelup" method="post" enctype="multipart/form-data">
              <input type="hidden" class="form-control" name="licenseid" value="<?php echo $row['licenseid']; ?>">
              
              
               <div class="form-group">
                  <label for="employeefile">License File</label>
