          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <div class="box box-danger">
                ...
                <div class="form-group">
					<label>Work Area<em>*</em></label>
					<select class="form-control" name="wl" id="wl">
                    	<option value="">Select</option>
                        <?php
						foreach($wl as $row)
						{
                    ...
                    <?php echo form_error('wl', '<div class="error">', '</div>');  ?>
				</div>
               </div>
                <!-- /.box-body -->
...
//			var positionid= $("#positionid").val();
            ...
            $.ajax(
                {
                    type:'post',
                    url: '<?php echo base_url(); ?>Dashboard/date_wise_baslagri_tincentive_summary',
					dataType:"text",
                    data:{ mo:mo,yr:yr,wl:wl},
