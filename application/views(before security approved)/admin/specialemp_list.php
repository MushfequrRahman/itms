            ...
            <div class="col-md-12">
              ...
              <div class="box box-danger">
                <div class="box-header with-border">
                  <h3 class="box-title">Special Employee List</h3>
					<div class="row">
            ...
            <div class="box-body table-responsive no-padding">
              ...
              <thead style="background:#91b9e6;">
                ...
                <tr>
                  ...
                  <td style="vertical-align:middle;"><img class="profile-user-img img-responsive img-thumbnail" src="<?php echo base_url().'assets/uploads/susers/'.$row['pic_file'];?>" alt="User profile picture"></td>
                  <td style="vertical-align:middle;"><?php echo $row['factory'];?></td>
                  ...
                  <td style="vertical-align:middle;"><?php echo $row['peradd'];?></td>
                  <td style="vertical-align:middle;"><?php echo $row['preadd'];?></td>
