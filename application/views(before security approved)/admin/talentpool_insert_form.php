          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <div class="box box-danger">
                ...
                <!-- /.box-header -->
                <div class="box-body ">
				 <form role="form" autocomplete="off" action="<?php echo base_url();?>Dashboard/talentpool_insert" method="post" enctype="multipart/form-data">
				...
				<?php /*?><div class="form-group">
					...
					<input type="text" class="form-control pd" name="dobdate" value="<?php echo date('d-m-Y');?>"><?php */?>
                    <?php /*?><?php echo form_error('dobdate', '<div class="error">', '</div>');  ?><?php */?>
				<?php /*?></div><?php */?>
                <?php /*?><div class="form-group">
					<label>Date Of Join<em>*</em></label>
					<input type="text" class="form-control pd" name="dojdate" value="<?php echo date('d-m-Y');?>"><?php */?>
                ...
                <div class="form-group">
					...
					<input type="text" class="form-control" name="fileno" placeholder="Enter File No">
                ...
                <div class="form-group">
                  <label for="employeefile">User CV</label>
