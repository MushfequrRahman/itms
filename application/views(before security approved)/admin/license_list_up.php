            ...
            <div class="tab-content">
              ...
              <div class="form-group">
                ...
                <div class="form-group">
					...
					<input type="text" class="form-control" readonly name="licensename" value="<?php echo $row['license_name'];?>">
                ...
                <div class="form-group">
					...
					<select class="form-control" readonly name="divisionid" id="divisionid">
