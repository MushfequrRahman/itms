            ...
            <div class="col-md-12">
              ...
              <div class="box box-danger">
                <div class="box-header with-border">
                  <h3 class="box-title">Compliance Expense Info Insert</h3>
					<div class="row">
                ...
                <!-- /.box-header -->
				 ...
				 <form role="form" id="comment" autocomplete="off" action="<?php echo base_url();?>Dashboard/complianceexp_insert" method="post" enctype="multipart/form-data">
                <div class="box-body ">
                ...
                <div class="form-group">
					<label>Audit Name<em>*</em></label>
					<select class="form-control" name="auditname" id="auditname">
                    	<option value="">Select....</option>
                        <?php
						foreach($allname as $row)
						{
					?>
                    		<option value="<?php echo $row['auditnameid'];?>"><?php echo $row['auditname'];?></option>
                    <?php
						}
					?>
                    </select>
                    <?php echo form_error('auditnameid', '<div class="error">', '</div>');  ?>
				</div>
                <div class="form-group">
					<label>Scope<em>*</em></label>
					<select class="form-control" name="auditscope" id="auditscope">
						...
						{
					?>
                    		<option value="<?php echo $row['acid'];?>"><?php echo $row['auditscopename'];?></option>
                    <?php
						}
					?>
                    </select>
                ...
                <div class="form-group">
					...
					<select class="form-control" name="audittype" id="audittype">
						...
						{
					?>
                    		<option value="<?php echo $row['atid'];?>"><?php echo $row['audittypename'];?></option>
                    <?php
						}
					?>
                    </select>
                ...
                <div class="form-group">
					...
					<select class="form-control" name="auditparty" id="auditparty">
						...
						{
					?>
                    		<option value="<?php echo $row['apid'];?>"><?php echo $row['apname'];?></option>
                    <?php
						}
					?>
                    </select>
               ...
               <div class="form-group">
                ...
                <div class="form-group">
					...
					<input type="text" class="form-control" name="inumber" placeholder="Invoice Number">
                </div>
				<div class="form-group">
					<label>Invoice Date<em>*</em></label>
					<input type="text" class="form-control pd" name="idate" id="idate" value="">
                </div>
                <div class="form-group">
					<label>Invoice Amount<em>*</em></label>
					<input type="text" class="form-control" name="iamount" placeholder="Invoice Amount">
                </div>
                <div class="form-group">
					<label>Currency<em>*</em></label>
					<select class="form-control" name="icurrency" id="currency">
                    	<option value="">Select....</option>
                        <?php
						foreach($cl as $row)
						{
					?>
                    		<option value="<?php echo $row['cid'];?>"><?php echo $row['currency'];?></option>
                    <?php
						}
					?>
                    </select>
                    <?php echo form_error('currency', '<div class="error">', '</div>');  ?>
                </div>
				<div class="form-group">
					<label>Payment Date<em>*</em></label>
					<input type="text" class="form-control pd" name="pdate" id="pdate" value="">
                </div>
                <div class="form-group">
					<label>Payment Amount<em>*</em></label>
					<input type="text" class="form-control" name="pamount" placeholder="Payment Amount">
                </div>
                <div class="form-group">
					<label>Currency<em>*</em></label>
					<select class="form-control" name="pcurrency" id="currency">
                    	<option value="">Select....</option>
                        <?php
						foreach($cl as $row)
						{
                ...
                <div class="form-group">
					<label>Audit Company<em>*</em></label>
					<select class="form-control" name="auditcomp" id="auditcomp">
                    	<option value="">Select....</option>
                        <?php
						foreach($col as $row)
						{
					?>
                    		<option value="<?php echo $row['acnid'];?>"><?php echo $row['auditcomp'];?></option>
                    <?php
						}
					?>
                    </select>
                    <?php echo form_error('auditcomp', '<div class="error">', '</div>');  ?>
                </div>
                <div class="form-group">
					<label>Tenure Start Date<em>*</em></label>
					<input type="text" class="form-control pd" name="tsdate" id="tsdate" value="">
                </div>
                <div class="form-group">
					<label>Tenure End Date<em>*</em></label>
					<input type="text" class="form-control pd" name="tedate" id="tedate" value="">
                </div>
				<div class="form-group">
					<label>Co-Ordinated By<em>*</em></label>
					<input type="text" class="form-control" name="coordinate" placeholder="Co-Ordinated By(User ID)">
                </div>
                <div class="form-group">
					<label>Remarks</label>
                ...
                <div class="form-group">
                  <label for="employeefile1">Invoice File</label>
                  <!--<input type="checkbox" name="chk1">-->
                  <input type="file" name="invoice_file">
				</div>
                <div class="form-group">
                  <label for="employeefile">Payment File</label>
