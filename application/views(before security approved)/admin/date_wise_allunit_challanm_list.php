            ...
            <div class="box-body table-responsive no-padding">
              ...
              <thead style="background:#91b9e6;">
                ...
                <tr>
                  ...
                  <?php /*?><td style="vertical-align:middle;"><?php echo $row['challantype'];?></td><?php */?>
                  <?php /*?><td style="vertical-align:middle;"><?php echo $row['producttype'];?></td><?php */?>
                  <?php /*?><td style="vertical-align:middle;"><?php echo $row['item_name'];?></td><?php */?>
