            ...
            <div class="col-md-12">
              ...
              <div class="box box-danger">
                <div class="box-header with-border">
                  <h3 class="box-title">Blood Group Insert</h3>
					<div class="row">
                ...
                <div class="box-body ">
				 <form role="form" autocomplete="off" action="<?php echo base_url();?>Dashboard/bloodgroup_insert" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
					<label>Human Nature<em>*</em></label>
					<input type="text" class="form-control" name="humannature" placeholder="Enter Human Nature">
                    <?php echo form_error('humannature', '<div class="error">', '</div>');  ?>
				</div>
                <div class="form-group">
					<label>Best Traits<em>*</em></label>
					<input type="text" class="form-control" name="besttraits" placeholder="Enter Best Traits">
                    <?php echo form_error('besttraits', '<div class="error">', '</div>');  ?>
				</div>
                <div class="form-group">
					<label>Worst Traits<em>*</em></label>
					<input type="text" class="form-control" name="worsttraits" placeholder="Enter Worst Traits">
                    <?php echo form_error('worsttraits', '<div class="error">', '</div>');  ?>
				</div>
				<div class="form-group">
					<label>Personality<em>*</em></label>
					 <textarea class="form-control"  name="personality" rows="5" id="personality"></textarea>
                    <?php echo form_error('personality', '<div class="error">', '</div>');  ?>
				</div>
              </div>
