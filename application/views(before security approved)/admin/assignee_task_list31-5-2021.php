            ...
            <div class="box-body table-responsive no-padding">
              ...
              <thead style="background:#91b9e6;">
                ...
                <tr>
				  ...
				  {
					  ?>
                  <td style="vertical-align:middle; background:#FF6;color:#999;font-weight:bold;"><?php echo $deadline;?></td>
                  <?php
				  }
				  elseif(date('Y-m-d') > $row['deadline'])
				  {
				  ?>
                  <td style="vertical-align:middle; background: #900;color:#999;font-weight:bold;"><?php echo $deadline;?></td>
                  <?php
				  }
                  elseif($prevday)
				  {
				  ?>
                  <td style="vertical-align:middle; background: #F90;color:#999;font-weight:bold;"><?php echo $deadline;?></td>
                  <?php
				  }
				  else
				  {
                 ...
                 <?php if($row['assignee_submitted_date']=='0000-00-00')
                  {
					  ?>
