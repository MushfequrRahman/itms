													...
													?>
														<tr>
															...
															elseif ($row['pastatus'] == 2) {
																?>
																	<td style="vertical-align:middle;">Disposed</td>
																<?php
																}
															?>
															<?php
															...
															if ($row['pastatus'] == 0) {
															?>
																<td style="vertical-align:middle;"><a href="<?php echo base_url(); ?>Dashboard/product_dispose_form/<?php echo $bn = $row['pacode']; ?>"><i class="fa fa-trash" style="font-size:24px"></i></a></td>
															<?php
															} elseif ($row['pastatus'] == 2) {
															?>
																<td style="vertical-align:middle;">Disposed</td>
