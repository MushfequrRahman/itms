  ...
  ?>
    <div class="wrapper" id="agreement<?php echo $i; ?>">
      ...
      <div class="top">
        ...
        <p style="text-align:center;font-size:8px;">This Is System Generated Document</p>
        <p style="text-align:center;font-size:8px;">Date: <?php echo date('d-m-Y'); ?> Time: <?php echo date('h:i:s A'); ?></p>
      </div>
    </div>
  <?php
    $i++;
