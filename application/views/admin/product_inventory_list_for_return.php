							...
							<div class="col-md-12">
								<div class="box box-danger">
									<div class="box-header with-border">
										<h3 class="box-title">Product Return</h3>
										<div class="row">
									...
									<form role="form" autocomplete="off" action="<?php echo base_url(); ?>Dashboard/product_multiple_return_insert" method="post" enctype="multipart/form-data">
