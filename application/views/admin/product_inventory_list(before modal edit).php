											...
											<div class="row">
												...
												<div class="col-md-6">
													<div class="float-right" style="text-align: right;">
														<button id="downloadExcel" class="btn-download-excel"><i class="fa fa-file-excel-o"></i>
															Excel</button>
														<!-- </div> -->
													</div>
												</div>
											...
											<tbody>
												...
												?>
													<tr>
														...
														?>
															<td style="vertical-align:middle; background:#348198;"><?php echo $row['pcname']; ?></td>
														<?php
														} else {
														?>
															<td style="vertical-align:middle; background:#29B5DB;"><?php echo $row['pcname']; ?></td>
														<?php
														}
														?>
														<td style="vertical-align:middle;"><?php echo $row['pgname']; ?></td>
														<td style="vertical-align:middle;"><a href="<?php echo base_url(); ?>Dashboard/description_wise_list/<?php echo $bn = $row['psgid']; ?>"><?php echo $row['psgname']; ?></a></td>
														...
														if ($remain >= 0) {
														?>
															<td style="vertical-align:middle; background:#819830;"><?php echo $remain; ?></td>
														<?php
														} else {
														?>
