    ...
    <tbody>
      ...
      foreach ($ul as $row) { ?>
        <tr>
          ...
          <td style="vertical-align:middle;"><a target="_blank" href="<?php echo base_url(); ?>Dashboard/product_inventory_insert_form/<?php echo $bn = $row['sipoid']; ?>"><?php echo $row['mprid']; ?></a></td>
