                      ...
                      <tbody>
                        ...
                        foreach ($ul as $row) { ?>
                          <tr>
                            ...
                            <?php /*?><td style="vertical-align:middle;"><a href="<?php echo base_url();?>Dashboard/designation_list_up/<?php echo $bn=$row['desigid'];?>"><i class="fa fa-edit" style="font-size:24px"></i></a></td><?php */ ?>
                          </tr>
                        <?php } ?>
                      </tbody>
